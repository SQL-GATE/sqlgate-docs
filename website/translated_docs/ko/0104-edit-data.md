...
![현재 SQL 실행 및 수정, run and modify current SQL, 오라클](https://resource.sqlgate.com/resource/captures/edit-data/run-and-modify-current-SQL-ko.png)
...
![테이블설명창에서 데이터 수정](https://resource.sqlgate.com/resource/captures/edit-data/edit-data-on-table-detail-window-ko.png)
